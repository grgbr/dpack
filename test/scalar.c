...
dpack_scalar_utest_encode_uint16(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* 0 */
		DPACKUT_UINT16("\x00",         0, UINT16_C(0)),
		/* 1 */
		DPACKUT_UINT16("\x01",         0, UINT16_C(1)),
		/* 65535 */
		DPACKUT_UINT16("\xcd\xff\xff", 0, UINT16_MAX),
	};
...
dpack_scalar_utest_decode_uint16(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -1 */
		DPACKUT_UINT16("\xff",                 -ENOMSG, UINT16_C(0)),
		/* 0 */
		DPACKUT_UINT16("\x00",                 0,       UINT16_C(0)),
		/* 1 */
		DPACKUT_UINT16("\x01",                 0,       UINT16_C(1)),
		...
		DPACKUT_UINT16("\xcd\xff\xff",         0,       UINT16_MAX),
		/* 65536 */
		DPACKUT_UINT16("\xce\x00\x01\x00\x00", -ERANGE, UINT16_C(0))
	};
...
dpack_scalar_utest_decode_uint16_min(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -1 */
		DPACKUT_UINT16_MIN("\xff",             -ENOMSG, 0,              UINT16_C(1)),
		/* 0 */
		DPACKUT_UINT16_MIN("\x00",             -ERANGE, 0,              UINT16_C(1)),
		/* 1 */
		DPACKUT_UINT16_MIN("\x01",             0,       UINT16_C(1),    UINT16_C(1)),
		/* 32767 */
		DPACKUT_UINT16_MIN("\xcd\x7f\xff",     0,       UINT16_MAX / 2, UINT16_C(1)),
		/* 65535 */
		DPACKUT_UINT16_MIN("\xcd\xff\xff",     0,       UINT16_MAX,     UINT16_C(1)),
		/* 65536 */
		DPACKUT_UINT16_MIN("\xce"
		                       "\x00\x01\x00\x00", -ERANGE, 0,              UINT16_C(1)),

		/* -1 */
		DPACKUT_UINT16_MIN("\xff",             -ENOMSG, 0,              UINT16_MAX / 2),
		/* 0 */
		DPACKUT_UINT16_MIN("\x00",             -ERANGE, 0,              UINT16_MAX / 2),
		/* 1 */
		DPACKUT_UINT16_MIN("\x01",             -ERANGE, 0,              UINT16_MAX / 2),
		/* 32766 */
		DPACKUT_UINT16_MIN("\xcd\x7f\xfe",     -ERANGE, 0,              UINT16_MAX / 2),
		/* 32767 */
		DPACKUT_UINT16_MIN("\xcd\x7f\xff",     0,       UINT16_MAX / 2, UINT16_MAX / 2),
		/* 65535 */
		DPACKUT_UINT16_MIN("\xcd\xff\xff",     0,       UINT16_MAX,     UINT16_MAX / 2),
		/* 65536 */
		DPACKUT_UINT16_MIN("\xce"
		                       "\x00\x01\x00\x00", -ERANGE, 0,              UINT16_MAX / 2),

		/* 65533 */
		DPACKUT_UINT16_MIN("\xcd\xff\xfd",     -ERANGE, 0,              UINT16_MAX - 1),
		/* 65534 */
		DPACKUT_UINT16_MIN("\xcd\xff\xfe",     0,       UINT16_MAX - 1, UINT16_MAX - 1),
		/* 65535 */
		DPACKUT_UINT16_MIN("\xcd\xff\xff",     0,       UINT16_MAX,     UINT16_MAX - 1),
		/* 65536 */
		DPACKUT_UINT16_MIN("\xce"
	...
	cute_expect_assertion(ret = dpack_decode_uint16_min(&dec,
	                                                    UINT16_MAX,
	                                                    &val));
	cute_expect_assertion(ret = dpack_decode_uint16_min(&dec, 1, NULL));
	dpack_decoder_fini(&dec);
#endif
...
dpack_scalar_utest_decode_uint16_max(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -1 */
		DPACKUT_UINT16_MAX("\xff",              -ENOMSG, 0,                    UINT16_C(1)),
		/* 0 */
		DPACKUT_UINT16_MAX("\x00",              0,       UINT16_C(0),          UINT16_C(1)),
		/* 1 */
		DPACKUT_UINT16_MAX("\x01",              0,       UINT16_C(1),          UINT16_C(1)),
		/* 255 */
		DPACKUT_UINT16_MAX("\xcc\xff",          -ERANGE, 0,                    UINT16_C(1)),
		/* 256 */
		DPACKUT_UINT16_MAX("\xcd\x01\x00",      -ERANGE, 0,                    UINT16_C(1)),

		/* 1 */
		DPACKUT_UINT16_MAX("\x01",              0,       UINT16_C(1),          UINT16_MAX / 2),
		/* 32766 */
		DPACKUT_UINT16_MAX("\xcd\x7f\xfe",      0,       (UINT16_MAX / 2) - 1, UINT16_MAX / 2),
		/* 32767 */
		DPACKUT_UINT16_MAX("\xcd\x7f\xff",      0,       UINT16_MAX / 2,       UINT16_MAX / 2),
		/* 32768 */
		DPACKUT_UINT16_MAX("\xcd\x80\x00",      -ERANGE, 0,                    UINT16_MAX / 2),
		/* 65535 */
		DPACKUT_UINT16_MAX("\xcd\xff\xff",      -ERANGE, 0,                    UINT16_MAX / 2),

		/* 65533 */
		DPACKUT_UINT16_MAX("\xcd\xff\xfd",      0,       UINT16_MAX - 2,       UINT16_MAX - 1),
		/* 65534 */
		DPACKUT_UINT16_MAX("\xcd\xff\xfe",      0,       UINT16_MAX - 1,       UINT16_MAX - 1),
		/* 65535 */
		DPACKUT_UINT16_MAX("\xcd\xff\xff",      -ERANGE, 0,                    UINT16_MAX - 1),
		/* 65536 */
		DPACKUT_UINT16_MAX("\xce"
		                       "\x00\x01\x00\x00" , -ERANGE, 0,                    UINT16_MAX - 1)
	};
	...
	cute_expect_assertion(ret = dpack_decode_uint16_max(&dec,
	                                                    UINT16_MAX,
	                                                    &val));
	cute_expect_assertion(ret = dpack_decode_uint16_max(&dec, 1, NULL));
	dpack_decoder_fini(&dec);
#endif
...
dpack_scalar_utest_decode_uint16_range(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -1 */
		DPACKUT_UINT16_RANGE("\xff",              -ENOMSG, 0,                    UINT16_C(1),    UINT16_C(2)),
		/* 0 */
		DPACKUT_UINT16_RANGE("\x00",              -ERANGE, 0,                    UINT16_C(1),    UINT16_C(2)),
		/* 1 */
		DPACKUT_UINT16_RANGE("\x01",              0,       UINT16_C(1),          UINT16_C(1),    UINT16_C(2)),
		/* 2 */
		DPACKUT_UINT16_RANGE("\x02",              0,       UINT16_C(2),          UINT16_C(1),    UINT16_C(2)),
		/* 3 */
		DPACKUT_UINT16_RANGE("\x03",              -ERANGE, 0,                    UINT16_C(1),    UINT16_C(2)),

		/* 1 */
		DPACKUT_UINT16_RANGE("\x01",              -ERANGE, 0,                    UINT16_MAX / 2, (UINT16_MAX / 2) + 1),
		/* 32766 */
		DPACKUT_UINT16_RANGE("\xcd\x7f\xfe",      -ERANGE, 0,                    UINT16_MAX / 2, (UINT16_MAX / 2) + 1),
		/* 32767 */
		DPACKUT_UINT16_RANGE("\xcd\x7f\xff",      0,       UINT16_MAX / 2,       UINT16_MAX / 2, (UINT16_MAX / 2) + 1),
		/* 32768 */
		DPACKUT_UINT16_RANGE("\xcd\x80\x00",      0,       (UINT16_MAX / 2) + 1, UINT16_MAX / 2, (UINT16_MAX / 2) + 1),
		/* 32769 */
		DPACKUT_UINT16_RANGE("\xcd\x80\x01",      -ERANGE, 0,                    UINT16_MAX / 2, (UINT16_MAX / 2) + 1),

		/* 65532 */
		DPACKUT_UINT16_RANGE("\xcd\xff\xfc",      -ERANGE, 0,                    UINT16_MAX - 2, UINT16_MAX - 1),
		/* 65533 */
		DPACKUT_UINT16_RANGE("\xcd\xff\xfd",      0,       UINT16_MAX - 2,       UINT16_MAX - 2, UINT16_MAX - 1),
		/* 65534 */
		DPACKUT_UINT16_RANGE("\xcd\xff\xfe",      0,       UINT16_MAX - 1,       UINT16_MAX - 2, UINT16_MAX - 1),
		/* 65535 */
		DPACKUT_UINT16_RANGE("\xcd\xff\xff",      -ERANGE, 0,                    UINT16_MAX - 2, UINT16_MAX - 1),

		/* 65536 */
		DPACKUT_UINT16_RANGE("\xce"
...
dpack_scalar_utest_encode_int16(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -32768 */
		DPACKUT_INT16("\xd1\x80\x00", 0, INT16_MIN),
		/* -32767 */
		DPACKUT_INT16("\xd1\x80\x01", 0, INT16_MIN + 1),
		/* -1 */
		DPACKUT_INT16("\xff",         0, INT16_C(-1)),
		/* 0 */
		DPACKUT_INT16("\x00",         0, INT16_C(0)),
		/* 1 */
		DPACKUT_INT16("\x01",         0, INT16_C(1)),
		/* 32767 */
		DPACKUT_INT16("\xcd\x7f\xff", 0, INT16_MAX)
	};
...
dpack_scalar_utest_decode_int16(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		...
		DPACKUT_INT16("\xcd\x7f\xff",     0,       INT16_MAX),
		/* 32768 */
		DPACKUT_INT16("\xcd\x80\x00",     -ERANGE, INT16_C(0))
	};
...
dpack_scalar_utest_decode_int16_min(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -32769 */
		DPACKUT_INT16_MIN("\xd2"
		                      "\xff\xff\x7f\xff", -ERANGE, 0,             INT16_MIN + 1),
		/* -32768 */
		DPACKUT_INT16_MIN("\xd1\x80\x00",     -ERANGE, 0,             INT16_MIN + 1),
		/* -32767 */
		DPACKUT_INT16_MIN("\xd1\x80\x01",     0,       INT16_MIN + 1, INT16_MIN + 1),
		/* -32766 */
		DPACKUT_INT16_MIN("\xd1\x80\x02",     0,       INT16_MIN + 2, INT16_MIN + 1),

		/* -1 */
		DPACKUT_INT16_MIN("\xff",             -ERANGE, 0,             INT16_C(0)),
		/* 0 */
		DPACKUT_INT16_MIN("\x00",             0,       INT16_C(0),    INT16_C(0)),
		/* 1 */
		DPACKUT_INT16_MIN("\x01",             0,       INT16_C(1),    INT16_C(0)),
		/* 32767 */
		DPACKUT_INT16_MIN("\xcd\x7f\xff",     0,       INT16_MAX,     INT16_C(0)),
		/* 32768 */
		DPACKUT_INT16_MIN("\xcd\x80\x00",     -ERANGE, 0,             INT16_C(0)),

		/* 32765 */
		DPACKUT_INT16_MIN("\xcd\x7f\xfd",     -ERANGE, 0,             INT16_MAX - 1),
		/* 32766 */
		DPACKUT_INT16_MIN("\xcd\x7f\xfe",     0,       INT16_MAX - 1, INT16_MAX - 1),
		/* 32767 */
		DPACKUT_INT16_MIN("\xcd\x7f\xff",     0,       INT16_MAX,     INT16_MAX - 1),
		/* 32768 */
		DPACKUT_INT16_MIN("\xcd\x80\x00",     -ERANGE, 0,             INT16_MAX - 1)
	};
...
dpack_scalar_utest_decode_int16_max(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -32769 */
		DPACKUT_INT16_MAX("\xd2"
		                      "\xff\xff\x7f\xff", -ERANGE, 0,             INT16_MIN + 1),
		/* -32768 */
		DPACKUT_INT16_MAX("\xd1\x80\x00",     0,       INT16_MIN,     INT16_MIN + 1),
		/* -32767 */
		DPACKUT_INT16_MAX("\xd1\x80\x01",     0,       INT16_MIN + 1, INT16_MIN + 1),
		/* -32766 */
		DPACKUT_INT16_MAX("\xd1\x80\x02",     -ERANGE, 0,             INT16_MIN + 1),

		/* -1 */
		DPACKUT_INT16_MAX("\xff",             0,       INT16_C(-1),   INT16_C(0)),
		/* 0 */
		DPACKUT_INT16_MAX("\x00",             0,       INT16_C(0),    INT16_C(0)),
		/* 1 */
		DPACKUT_INT16_MAX("\x01",             -ERANGE, 0,             INT16_C(0)),
		/* 32767 */
		DPACKUT_INT16_MAX("\xcd\x7f\xff",     -ERANGE, 0,             INT16_C(0)),
		/* 32768 */
		DPACKUT_INT16_MAX("\xcd\x80\x00",     -ERANGE, 0,             INT16_C(0)),

		/* 32765 */
		DPACKUT_INT16_MAX("\xcd\x7f\xfd",     0,       INT16_MAX - 2, INT16_MAX - 1),
		/* 32766 */
		DPACKUT_INT16_MAX("\xcd\x7f\xfe",     0,       INT16_MAX - 1, INT16_MAX - 1),
		/* 32767 */
		DPACKUT_INT16_MAX("\xcd\x7f\xff",     -ERANGE, 0,             INT16_MAX - 1),
		/* 32768 */
		DPACKUT_INT16_MAX("\xcd\x80\x00",     -ERANGE, 0,             INT16_MAX - 1)
	};
	...
	cute_expect_assertion(ret = dpack_decode_int16_max(&dec, 0, &val));
...
dpack_scalar_utest_decode_int16_range(void ** state __unused)
{
	static const struct dpack_scalar_utest_data data[] = {
		/* -32769 */
		DPACKUT_INT16_RANGE("\xd2"
		                        "\xff\xff\x7f\xff", -ERANGE, 0,             INT16_MIN + 1, INT16_MIN + 2),
		/* -32768 */
		DPACKUT_INT16_RANGE("\xd1\x80\x00",     -ERANGE, 0,             INT16_MIN + 1, INT16_MIN + 2),
		/* -32767 */
		DPACKUT_INT16_RANGE("\xd1\x80\x01",     0,       INT16_MIN + 1, INT16_MIN + 1, INT16_MIN + 2),
		/* -32766 */
		DPACKUT_INT16_RANGE("\xd1\x80\x02",     0,       INT16_MIN + 2, INT16_MIN + 1, INT16_MIN + 2),
		/* -32765 */
		DPACKUT_INT16_RANGE("\xd1\x80\x03",     -ERANGE, 0,             INT16_MIN + 1, INT16_MIN + 2),

		/* -1 */
		DPACKUT_INT16_RANGE("\xff",             -ERANGE, 0,             INT16_C(0),    INT16_C(1)),
		/* 0 */
		DPACKUT_INT16_RANGE("\x00",             0,       INT16_C(0),    INT16_C(0),    INT16_C(1)),
		/* 1 */
		DPACKUT_INT16_RANGE("\x01",             0,       INT16_C(1),    INT16_C(0),    INT16_C(1)),
		/* 2 */
		DPACKUT_INT16_RANGE("\x02",             -ERANGE, 0,             INT16_C(0),    INT16_C(1)),

		/* 32764 */
		DPACKUT_INT16_RANGE("\xcd\x7f\xfc",     -ERANGE, 0,             INT16_MAX - 2, INT16_MAX - 1),
		/* 32765 */
		DPACKUT_INT16_RANGE("\xcd\x7f\xfd",     0,       INT16_MAX - 2, INT16_MAX - 2, INT16_MAX - 1),
		/* 32766 */
		DPACKUT_INT16_RANGE("\xcd\x7f\xfe",     0,       INT16_MAX - 1, INT16_MAX - 2, INT16_MAX - 1),
		/* 32767 */
		DPACKUT_INT16_RANGE("\xcd\x7f\xff",     -ERANGE, 0,             INT16_MAX - 2, INT16_MAX - 1),
		/* 32768 */
		DPACKUT_INT16_RANGE("\xcd\x80\x00",     -ERANGE, 0,             INT16_MAX - 2, INT16_MAX - 1)
	};
