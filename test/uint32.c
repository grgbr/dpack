...
dpackut_uint32_encode(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_encode_uint32(&enc.base, data->value.uint32),
	                equal,
	                data->error);
...
CUTE_TEST(dpackut_uint32_encode_assert)
{
	...
	cute_expect_assertion(ret = dpack_encode_uint32(&enc.base, val));
...
dpackut_uint32_decode(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_uint32(&dec.base, &val),
	                equal,
	                data->error);
	if (!data->error) {
...
CUTE_TEST(dpackut_uint32_decode_assert)
{
	uint32_t                    val;
	struct dpack_decoder_buffer dec = { 0, };
	uint8_t                     buff[DPACK_UINT32_SIZE_MAX];
	int                         ret __unused;

	cute_expect_assertion(ret = dpack_decode_uint32(NULL, &val));
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_uint32(&dec.base, &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */

	dpack_decoder_init_buffer(&dec, buff, sizeof(buff));
	cute_expect_assertion(ret = dpack_decode_uint32(&dec.base, NULL));
	dpack_decoder_fini(&dec.base);
}
...
dpackut_uint32_decode_min(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_uint32_min(&dec.base,
	                                        data->low.uint32,
	                                        &val),
	                equal,
	                data->error);
...
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_uint32_min(&dec.base,
	                                                    1,
	                                                    &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */
...
dpackut_uint32_decode_max(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_uint32_max(&dec.base,
	                                        data->high.uint32,
	                                        &val),
	                equal,
	                data->error);
...
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_uint32_max(&dec.base,
	                                                    1,
	                                                    &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */
...
dpackut_uint32_decode_range(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_uint32_range(&dec.base,
	                                         data->low.uint32,
	                                         data->high.uint32,
	                                         &val),
	                equal,
...
CUTE_TEST(dpackut_uint32_decode_range_assert)
{
	...
	cute_expect_assertion(ret = dpack_decode_uint32_range(NULL,
	                                                      ...
	                                                      &val));
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_uint32_range(&dec.base,
	                                                      1,
	                                                      2,
	                                                      &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */
