...
dpackut_int8_encode(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_encode_int8(&enc.base, data->value.int8),
	                equal,
	                data->error);
...
CUTE_TEST(dpackut_int8_encode_assert)
{
	...
	cute_expect_assertion(ret = dpack_encode_int8(&enc.base, val));
...
dpackut_int8_decode(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_int8(&dec.base, &val), equal, data->error);
	if (!data->error) {
...
CUTE_TEST(dpackut_int8_decode_assert)
{
	int8_t                      val;
	struct dpack_decoder_buffer dec = { 0, };
	uint8_t                     buff[DPACK_INT8_SIZE_MAX];
	int                         ret __unused;

	cute_expect_assertion(ret = dpack_decode_int8(NULL, &val));
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_int8(&dec.base, &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */

	dpack_decoder_init_buffer(&dec, buff, sizeof(buff));
	cute_expect_assertion(ret = dpack_decode_int8(&dec.base, NULL));
	dpack_decoder_fini(&dec.base);
}
...
{
	/* -129 */
	DPACKUT_INT8(data, "\xd1\xff\x7f", -ENOMSG, 0);
...
{
	/* 128 */
	DPACKUT_INT8(data, "\xcc\x80", -ENOMSG, 0);
	dpackut_int8_decode(&data);
}
...
dpackut_int8_decode_min(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_int8_min(&dec.base, data->low.int8, &val),
	                equal,
	                data->error);
	if (!data->error) {
		cute_check_sint(val, equal, data->value.int8);
...
CUTE_TEST(dpackut_int8_decode_min_assert)
{
...
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_int8_min(&dec.base, 1, &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */
	cute_expect_assertion(ret = dpack_decode_int8_min(&dec.base,
	                                                  INT8_MIN,
	                                                  &val));
	cute_expect_assertion(ret = dpack_decode_int8_min(&dec.base,
	                                                  INT8_MAX,
	...
	dpack_decoder_init_buffer(&dec, buff, sizeof(buff));
	cute_expect_assertion(ret = dpack_decode_int8_min(&dec.base, 1, NULL));
	dpack_decoder_fini(&dec.base);
}
...
{
	/* -129 */
	DPACKUT_INT8_MIN(data, "\xd1\xff\x7f", -ENOMSG, 0, INT8_C(0));
...
{
	/* 128 */
	DPACKUT_INT8_MIN(data, "\xcc\x80", -ENOMSG, 0, INT8_C(0));
	dpackut_int8_decode_min(&data);
}
...
{
	/* 128 */
	DPACKUT_INT8_MIN(data, "\xcc\x80", -ENOMSG, 0, INT8_C(126));
	dpackut_int8_decode_min(&data);
}
...
dpackut_int8_decode_max(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_int8_max(&dec.base, data->high.int8, &val),
	                equal,
	                data->error);
	if (!data->error) {
		cute_check_sint(val, equal, data->value.int8);
...
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_int8_max(&dec.base, 1, &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */

	dpack_decoder_init_buffer(&dec, buff, sizeof(buff));
	cute_expect_assertion(ret = dpack_decode_int8_max(&dec.base,
	                                                  INT8_MIN,
	                                                  &val));
	cute_expect_assertion(ret = dpack_decode_int8_max(&dec.base,
	                                                  INT8_MAX,
	                                                  &val));
	cute_expect_assertion(ret = dpack_decode_int8_max(&dec.base, 1, NULL));
	dpack_decoder_fini(&dec.base);
}
...
{
	/* -129 */
	DPACKUT_INT8_MAX(data, "\xd1\xff\x7f", -ENOMSG, 0, INT8_C(0));
...
{
	/* 128 */
	DPACKUT_INT8_MAX(data, "\xcc\x80", -ENOMSG, 0, INT8_C(0));
	dpackut_int8_decode_max(&data);
}
...
{
	/* 128 */
	DPACKUT_INT8_MAX(data, "\xcc\x80", -ENOMSG, 0, INT8_C(126));
	dpackut_int8_decode_max(&data);
}
...
dpackut_int8_decode_range(const struct dpackut_scalar_data * data)
{
	...
	cute_check_sint(dpack_decode_int8_range(&dec.base,
	                                        data->low.int8,
	                                        data->high.int8,
	                                        &val),
	                equal,
...
#if defined(CONFIG_DPACK_DEBUG)
	cute_expect_assertion(ret = dpack_decode_int8_range(&dec.base,
	                                                    1,
	                                                    2,
	                                                    &val));
#endif /* defined(CONFIG_DPACK_DEBUG) */
