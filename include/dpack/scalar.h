...
#define DPACK_UINT8_SIZE_MIN (DPACK_UINT_SIZE_MIN)
...
#define DPACK_UINT16_SIZE_MIN (DPACK_UINT_SIZE_MIN)
...
#define DPACK_UINT32_SIZE_MIN (DPACK_UINT_SIZE_MIN)
...
#define DPACK_UINT64_SIZE_MIN (DPACK_UINT_SIZE_MIN)
