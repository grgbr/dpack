...
#elif DPACK_STRLEN_MAX > DPACK_STR8_LEN_MAX

/* Maximum number of characters an 16 bits msgpack string may encode */
#define DPACK_STR16_LEN_MAX \
	((UINT16_MAX) - 1)
...
#elif DPACK_STRLEN_MAX > DPACK_STR16_LEN_MAX

/* Maximum number of characters an 32 bits msgpack string may encode */
#define DPACK_STR32_LEN_MAX \
	((UINT32_MAX) - 1)
...
/*
 * Msgpack cannot encode strings containing more than (UINT32_MAX - 1) elements.
 */
#elif DPACK_STRLEN_MAX > DPACK_STR32_LEN_MAX
